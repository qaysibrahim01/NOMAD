            ...
            <section class="home" id="home">
                ...
                <div class="home__container container grid">
                    <div class="home__data">
                        ...
                        <a href="<?php echo e(route('explore')); ?>" class="button">Explore</a>
            ...
            <section class="place section" id="place">
                ...
                <div class="place__container container grid">
                    ...
                    <div class="place__card">
                        ...
                        <a href="<?php echo e(route('bali')); ?>" class="button button--flex place__button">
                        ...
                        <div class="place__content">
                            ...
                            <div class="place__data">
                                ...
                                <span class="place__price">$1599</span>
                                    ...
                                    <a href="<?php echo e(route('bora')); ?>" class="button button--flex place__button">
                                      <i class="ri-arrow-right-line"></i>
                                    </a>
                        ...
                        <div class="place__content">
                            ...
                            <div class="place__data">
                                ...
                                <span class="place__price">$3499</span>
                                    ...
                                    <a href="<?php echo e(route('Hawaii')); ?>" class="button button--flex place__button">
                                      <i class="ri-arrow-right-line"></i>
                                    </a>
                    </div>
                        ...
                        <div class="place__content">
                            ...
                            <div class="place__data">
                                ...
                                <span class="place__price">$2499</span>
                                    ...
                                    <a href="<?php echo e(route('White')); ?>" class="button button--flex place__button">
                                      <i class="ri-arrow-right-line"></i>
                                    </a>
                    </div>
                        ...
                        <div class="place__content">
                            ...
                            <div class="place__data">
                                ...
                                <span class="place__price">$1999</span>
                                    ...
                                    <a href="<?php echo e(route('Hvar')); ?>" class="button button--flex place__button">
                                      <i class="ri-arrow-right-line"></i>
                                    </a>
                    </div>
                </div>
...
<?php echo $__env->make('master.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Project_1\resources\views/mainpage.blade.php ENDPATH**/ ?>